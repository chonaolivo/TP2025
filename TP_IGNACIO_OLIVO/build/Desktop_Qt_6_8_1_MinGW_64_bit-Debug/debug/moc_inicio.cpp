...
namespace {
struct qt_meta_tag_ZN6InicioE_t {};
} // unnamed namespace


#ifdef QT_MOC_HAS_STRINGDATA
static constexpr auto qt_meta_stringdata_ZN6InicioE = QtMocHelpers::stringData(
    "Inicio"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN6InicioE[] = {
...
Q_CONSTINIT const QMetaObject Inicio::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN6InicioE.offsetsAndSizes,
    qt_meta_data_ZN6InicioE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN6InicioE_t,
        // Q_OBJECT / Q_GADGET
...
void *Inicio::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN6InicioE.stringdata0))
